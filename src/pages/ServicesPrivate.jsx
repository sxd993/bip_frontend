    ...
    <div className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-800 mb-6">{serviceData.physical.title}</h1>
          <p className="text-lg md:text-xl text-gray-600">Защита ваших прав и интересов в различных жизненных ситуациях</p>
        </div>
